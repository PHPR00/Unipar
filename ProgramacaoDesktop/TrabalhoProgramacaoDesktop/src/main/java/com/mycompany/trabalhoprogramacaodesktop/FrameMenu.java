...
public class FrameMenu extends javax.swing.JFrame {
    ...
    public boolean validarCampos(JTextField campo, String nomeDoCampo) {
        ...
        if (valorCampo.isEmpty()) {
            JOptionPane.showMessageDialog(this, "O campo " + nomeDoCampo + " não pode estar vazio.", "Erro", JOptionPane.ERROR_MESSAGE);
            campo.requestFocus();
            return false;
    ...
    public void mostrarDados(){
        ...
        for (int i = 0; i < Controller.listaPeca.size(); i++) {
            ...
            pecas += peca.getNome()+" - "+peca.getValor()+"<br>";
            valorTotal += peca.getValor();
            
        }
        pecas += "</html>";
        jLabel30.setText(pecas);
